...
const ContactBox = styled.div`
  background: linear-gradient(135deg, #090040 0%, #2a007d 100%);
  color: white;
  padding: 2rem;
  border-radius: 12px;
  margin-top: 3rem;
      ...
      <Content>
        ...
        <Section>
          ...
          <ul>
            ...
            <li><strong>Application</strong> refers to Eventflow, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Eventflow.</li>
        ...
        <Section>
          ...
          <ul>
            ...
            <li>Gender</li>
            <li>Country</li>
            <li>Profile picture (when using Google Sign-In)</li>
          </ul>
        ...
        <ContactBox>
          ...
          <p>
            <strong>By email:</strong> <a href="mailto:baaszunnaiyyer@gmail.com">baaszunnaiyyer@gmail.com</a>
          </p>
          <p>
            <strong>By visiting this page on our website:</strong> <a href="https://event-flow-three.vercel.app/" target="_blank" rel="noopener noreferrer">https://event-flow-three.vercel.app/</a>
          </p>
          <p>
            <strong>By phone:</strong> <a href="tel:+923493131433">+923493131433</a>
          </p>
        </ContactBox>
      </Content>
    </InfoContainer>
